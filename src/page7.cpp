...
namespace {
    ...
    {
        Manager::manager.desktopShortcut = dynamic_cast<Fl_Check_Button *>(button)->value();
...
void page_7()
{
    ...
    const auto check_button = new Fl_Check_Button(100 + png_size, 220, 500, 25,"Create shortcut on Desktop");
