...
public:
    ...
    bool hasMcfForSelection();

    // bool areMcf();

    [[nodiscard]] bool isMcfSelected() const;
...
private:
    ...
    static void fillBuffer(std::vector<BuildInfo> &buff, const std::string &readBuffer);
    ...
    [[nodiscard]] std::string createBat() const;

    [[nodiscard]] std::string createIcon() const;
